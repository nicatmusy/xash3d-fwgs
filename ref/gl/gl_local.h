...
extern convar_t bash3d_wallhack_enable;
extern convar_t bash3d_viewmodel_renderer;
extern convar_t bash3d_viewmodel_rendercolor_r;
extern convar_t bash3d_viewmodel_rendercolor_g;
extern convar_t bash3d_viewmodel_rendercolor_b;
