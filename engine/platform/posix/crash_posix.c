...
// eski crash handler'ları global scope'ta tanımla
...
static void Sys_Crash(int signal, siginfo_t *si, void *context)
{
    ...
    // Crash öncesi server restart mantığı buraya eklenebilir
    // Örn: Sys_RestartServer();
...
#endif // XASH_FREEBSD || XASH_NETBSD || XASH_OPENBSD || XASH_ANDROID || XASH_LINUX || XASH_APPLE
